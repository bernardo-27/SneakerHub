      ...
      <Carousel className="w-100">
        ...
        <Carousel.Item>
          <div className="carousel-content d-flex align-items-center">
            <img className="flexing-image" src={logoAnta} alt="Sneaker 1" />
        ...
        <Carousel.Item>
          <div className="carousel-content d-flex align-items-center">
            <img className="flexing-image" src={logoNike} alt="Nike Sneakers" />
            <div className="carousel-text">
        ...
        <Carousel.Item>
          <div className="carousel-content d-flex align-items-center">
            <img className="flexing-image" src={logoAnta} alt="Anta Sneakers" />
            <div className="carousel-text">
              <h3>Anta Sports</h3>
