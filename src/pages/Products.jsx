          ...
          <div className="col-md-3 mt-4" key={index}>
            <div className="card">
              ...
              <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => window.location.href = "/signup"}>Buy Now </button>
                <button className="btn btn-primary mt-2" onClick={() => window.location.href = "/signup"}>Add to Cart</button>
              </div>
            </div>
          </div>
        ))}
